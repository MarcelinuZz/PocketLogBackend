...
export default function verifyChallengeToken(challengeToken, expectedAction, expectedEmail) {
    try {
        ...
        if (String(decoded.sub) !== String(expectedEmail)) {
            return { valid: false, message: "Challenge token tidak sesuai dengan Email ini." };
        }
